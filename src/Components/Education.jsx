        ...
        >
          ...
          <Box className="grid grid-cols-1 sm:grid-cols-1 md:grid-col-2 lg:grid-cols-2 gap-4 mx-auto max-w-5xl">
            <TextField
              ...
              defaultValue={
                props.education ? props.education[fieldCd.Type] : ""
              }
          ...
          <Box className="grid grid-cols-1 sm:grid-cols-1 md:grid-col-2 lg:grid-cols-2 gap-4 mx-auto max-w-5xl mt-4">
            <TextField
              ...
              defaultValue={
                props.education ? props.education[fieldCd.University] : ""
              }
              error={errors[fieldCd.University] ? true : false}
              helperText={
                errors[fieldCd.University] && "University is required"
              }
            />
            ...
            <TextField
              ...
              defaultValue={
                props.education ? props.education[fieldCd.Degree] : ""
              }
          ...
          <Box className="grid grid-cols-1 sm:grid-cols-1 md:grid-col-2 lg:grid-cols-2 gap-4 mx-auto w-50vw mt-4">
            <TextField
              ...
              defaultValue={
                props.education ? props.education[fieldCd.Startyear] : ""
              }
            ...
            <TextField
              ...
              defaultValue={
                props.education ? props.education[fieldCd.Endyear] : ""
              }
          ...
          <div style={{ marginTop: "2vw" }}>
            ...
            >
              {props.education ? "Updated" : "Submit"}
            </Button>
          </div>
        </Card>
      </div>
