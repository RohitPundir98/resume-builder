...
import {
  setexperience,
  updateexperience,
} from "../Redux/actions/setexperience";
        ...
        <Box>
          ...
          {experience.map((item, key) => (
            <div key={key}>
              ...
              >
                <Typography
                  style={{ color: "black", marginBottom: "3vw" }}
                  variant="h6"
                >
                ...
                <Box className="grid grid-cols-1 sm:grid-cols-1 md:grid-col-2 lg:grid-cols-2 gap-4 mx-auto">
                  <TextField
                    ...
                    label="Job Title"
                    variant="outlined"
                    {...register(`experience[${key}].jobTitle`, {
                      required: true,
                    })}
                    value={item.jobTitle}
                    error={
                      errors?.experience && errors.experience[key]?.jobTitle
                    }
                    helperText={
                      errors?.experience &&
                      errors.experience[key]?.jobTitle &&
                  ...
                  <TextField
                    ...
                    variant="outlined"
                    {...register(`experience[${key}].organizationName`, {
                      required: true,
                    })}
                    value={item.organizationName}
                    error={
                      errors?.experience &&
                      errors.experience[key]?.organizationName
                    }
                    helperText={
                      errors?.experience &&
                      errors.experience[key]?.organizationName &&
                ...
                <Box className="grid grid-cols-1 sm:grid-cols-1 md:grid-col-2 lg:grid-cols-2 gap-4 mx-auto max-w-5xl mt-8">
                  <TextField
                    ...
                    label="Start Year"
                    variant="outlined"
                    {...register(`experience[${key}].startYear`, {
                      required: true,
                    })}
                    value={item.startYear}
                    error={
                      errors?.experience && errors.experience[key]?.startYear
                    }
                    helperText={
                      errors?.experience &&
                      errors.experience[key]?.startYear &&
                  ...
                  <TextField
                    ...
                    label="End Year"
                    variant="outlined"
                    {...register(`experience[${key}].endYear`, {
                      required: true,
                    })}
                    value={item.endYear}
                    error={
                      errors?.experience && errors.experience[key]?.endYear
                    }
                    helperText={
                      errors?.experience &&
                      errors.experience[key]?.endYear &&
                ...
                {key === experience.length - 1 && (
                  <div style={{ marginTop: "2vh" }}>
                    <Button
                      ...
                      onClick={onSubmit}
                    >
                      {props.experience ? "Updated" : "Submit"}
                    </Button>
                  </div>
                )}
              </Card>
