...
function Preview(props) {
  ...
  return (
    <>
      ...
      {error === true ? (
        <div className="fixed z-50 top-0 right-0 flex flex-col items-center gap-8 w-full h-full p-6 backdrop-blur-sm  text-xl  md:w-[100%]">
          <div className=" min-h-screen flex items-center justify-center ">
            <div className="bg-white rounded-lg  py-8 px-12 border border-black shadow-lg ">
              ...
              <div className="flex justify-center mb-8 animate-bounce">
                <img className="w-32" src={right} alt="dowloaded" />
              </div>
      ...
      <div className="flex flex-wrap p-3 w-full justify-center  ">
        {/* Resume preview div  */}
        <div
          style={{
            marginTop: "5vh",
        ...
        >
          {resume == null ? (
            <img style={{ width: "20vw" }} src={nodata} alt="no data found" />
          ) : (
            resume.data
          )}
        </div>
